...
import 'package:dongpakka_pomodoro/size_config.dart';
import 'package:dongpakka_pomodoro/widgets/task_tile.dart';
          ...
          child: ListView.builder(
              scrollDirection:
                  MediaQuery.of(context).orientation == Orientation.portrait
                      ? Axis.vertical
                      : Axis.horizontal,
              itemCount: TimerPage.taskList.length,
              itemBuilder: (BuildContext context, int index) {
                Task task = TimerPage.taskList[index];
